...
export function Footer() {
  return (
    <footer className="bg-zinc-950 text-zinc-400 pt-24 pb-12 relative overflow-hidden border-t border-zinc-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-24">
          ...
          <div className="lg:col-span-5 space-y-8 pr-8">
            ...
            <div className="flex items-center space-x-4 pt-4">
              {[
                ...
                <a key={i} href="#" aria-label={social.name} className="text-zinc-500 hover:text-white transition-colors duration-300">
                  {social.icon}
                </a>
              ))}
            </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <ul className="space-y-4 text-sm">
              <li><Link href="/city-showcase" className="hover:text-white transition-colors">Showcase</Link></li>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <ul className="space-y-4 text-sm">
              <li><Link href="#" className="hover:text-white transition-colors">Digital OOH</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Transit Media</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Airport Branding</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Mall Activations</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <ul className="space-y-4 text-sm">
              <li><span className="block text-zinc-500 mb-1 text-xs uppercase tracking-widest">Office</span>Level 4, Trade Centre, BKC, Bandra East, Mumbai, 400051</li>
              <li><span className="block text-zinc-500 mb-1 text-xs uppercase tracking-widest">Phone</span>+91 98765 43210</li>
              <li><span className="block text-zinc-500 mb-1 text-xs uppercase tracking-widest">Email</span>hello@apexooh.com</li>
            </ul>
          </div>
        </div>
